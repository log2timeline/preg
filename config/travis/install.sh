...
L2TBINARIES_DEPENDENCIES="PyYAML XlsxWriter artifacts bencode binplist construct dfdatetime dfvfs dfwinreg dpkt efilter hachoir-core hachoir-metadata hachoir-parser ipython libbde libesedb libevt libevtx libewf libfsntfs libfvde libfwnt libfwsi liblnk libmsiecf libolecf libqcow libregf libscca libsigscan libsmdev libsmraw libvhdi libvmdk libvshadow libvslvm lzma pefile plaso psutil pycrypto pyparsing pysqlite python-dateutil pytsk3 pytz pyzmq requests six yara-python";
